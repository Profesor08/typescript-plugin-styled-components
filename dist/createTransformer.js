            ...
            const visitor = (node) => {
                if (minify &&
                    ...
                    if (minifiedTemplate && minifiedTemplate !== node.template) {
                        const newNode = context.factory.createTaggedTemplateExpression(node.tag, node.typeArguments, minifiedTemplate);
                        // @ts-ignore
                ...
                if (node.parent &&
                    ((ts_is_kind_1.isTaggedTemplateExpression(node.parent) &&
